...
const sections = [
  ...
  ["13. Governing Law and Disputes", <><p key="law">These Terms are governed by the laws of the State of Florida, without regard to conflict-of-law principles.</p>
    <p key="informal" className="mt-4"><strong>Step 1 — Informal resolution.</strong> Before initiating any formal proceeding, the party with a dispute must send written notice to the other describing the claim and the relief sought. The parties will attempt to resolve the dispute informally for 30 days from the date notice is received. This step is a condition precedent to arbitration or litigation.</p>
    <p key="arbitration" className="mt-4"><strong>Step 2 — Binding arbitration.</strong> If informal resolution fails, any dispute, claim, or controversy arising out of or relating to these Terms or the Service — including questions of arbitrability — will be resolved by binding arbitration administered by JAMS under its Streamlined Arbitration Rules (for claims under $250,000) or its Comprehensive Arbitration Rules (for larger claims), as applicable. Arbitration will be conducted in Miami-Dade County, Florida, or remotely if both parties agree. The arbitrator&apos;s award is final and may be entered as a judgment in any court of competent jurisdiction.</p>
    <p key="carveouts" className="mt-4"><strong>Court access preserved for:</strong></p>
    <ul key="carve-list" className="mt-2 list-disc space-y-2 pl-5">
      <li><strong>Injunctive or equitable relief</strong> — either party may seek a temporary restraining order or preliminary injunction in any court of competent jurisdiction to prevent irreparable harm while arbitration is pending.</li>
      <li><strong>Intellectual property disputes</strong> — claims involving ownership, infringement, or misappropriation of intellectual property may be brought directly in court.</li>
      <li><strong>Small claims</strong> — either party may bring an eligible claim in small claims court in Miami-Dade County in lieu of arbitration.</li>
    </ul>
    <p key="class" className="mt-4"><strong>No class actions.</strong> All proceedings must be brought in the parties&apos; individual capacity. Neither party may bring or participate in any class, collective, or representative proceeding, whether in arbitration or court. The arbitrator has no authority to consolidate claims or preside over any class proceeding.</p>
    <p key="venue" className="mt-4"><strong>Venue for court proceedings.</strong> For any matter properly brought in court under the carve-outs above, the parties consent to exclusive jurisdiction and venue in the state and federal courts located in Miami-Dade County, Florida.</p>
  </>],

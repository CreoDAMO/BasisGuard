...
const sections = [
  ...
  ["3. Accounts and Eligibility", <><p key="eligibility">You must be at least 18 years old and capable of forming a binding contract to use the Service. You&apos;re responsible for maintaining the confidentiality of your account credentials and for all activity under your account. Notify us promptly at <strong>[SECURITY CONTACT EMAIL]</strong> if you suspect unauthorized access.</p><p key="credential" className="mt-4">If you&apos;re a reviewer or preparer (a <code>reviewer</code> or <code>super_admin</code> role), you represent that any professional credential you enter is accurate and that you are authorized to use it, and that any sign-off you provide reflects your own genuine professional review.</p></>],
  ...
  ["7. Limitation of Liability", <><p key="florida">Under Florida law, limitation of liability clauses between commercial parties are generally enforceable when clear, mutual, reasonable, and not an attempt to eliminate liability entirely. This clause does not waive liability for fraud, intentional misrepresentation, or violations of consumer-protection law that cannot be limited by contract.</p><p key="limit" className="mt-4">To the maximum extent permitted by law: the Company&apos;s total liability arising out of or relating to the Service will not exceed the amount you paid the Company in the twelve months preceding the claim, or <strong>[$100 / one month&apos;s subscription fee — set this before publishing]</strong>, whichever is greater. The Company is not liable for indirect, incidental, consequential, or punitive damages, including tax penalties, interest, audit costs, or lost profits, arising from your use of or reliance on the Service.</p></>],
  ["8. Fees and Payment", <><p key="pricing"><strong>[Pricing model — subscription tier, per-seat, usage-based — needs to be finalized before this section is complete.]</strong></p><p key="payment" className="mt-4">BasisGuard supports payment via <strong>[traditional card processing and/or Coinbase Commerce / direct USDC — confirm which are live before publishing]</strong>. If you pay via cryptocurrency, you are responsible for any tax consequences of that payment method. Fees are described at the time of purchase and are non-refundable except as required by law or as separately stated in a specific offer.</p></>],
  ...
  ["14. Contact", <p key="contact"><strong>[ENTITY NAME]</strong><br /><strong>[MAILING ADDRESS]</strong><br /><strong>[CONTACT EMAIL]</strong></p>],
] as const;

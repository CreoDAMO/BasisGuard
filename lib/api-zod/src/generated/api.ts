...
export const ListLotsResponse = zod.object({
  ...
  "disposal_position_id": zod.string().nullish(),
...
export const CreateLotBody = zod.object({
  ...
  "position_record_id": zod.string().optional(),
  "notes": zod.string().optional()
})
